// =====================================================================
//  Drone component tray  —  v12 "SLEEK + DUCTS + GPS cable path".
//  Cube Orange (+Here4) / Herelink / Jetson / RFD900.  BASE + full LID.
//  v11 + the real Here4 cable hole (7.5x10, ~12.3 from the GPS back edge)
//  is now bored at its true offset location with a guided chute down
//  through the deck to the cube carrier.  v6..v11 untouched.
//
...
echo(str("v12 GPS-cable-path  L=", L, "  Here4 hole x=", gps_cab_x, " (", gps_cab_l, "x", gps_cab_w, ")"));
