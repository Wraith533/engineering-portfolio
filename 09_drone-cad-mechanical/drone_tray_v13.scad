// =====================================================================
//  Drone component tray  —  v13 "long jetson duct".
//  Cube Orange (+Here4) / Herelink / Jetson / RFD900.  BASE + full LID.
//  v12 + the Jetson duct straight run lengthened (jet_out=35) so a rigid
//  micro-HDMI plug seats before the bend.  v6..v12 untouched.
//
...
echo(str("v13 long-jet-duct  L=", L, "  jetson duct straight run ", jet_out, "mm out, bore ", duct_bore));
...
jet_out  = 35;                         // LONG straight run so the rigid plug seats (v13)
...
module lid() {
    union() {
        difference() {
            ...
            // open the bottom of the jetson ducts (cable drops out underneath)
